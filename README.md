...
This is a fork of a fork of deej.

This is forked from [here](https://github.com/Miodec/deej)

which is originally a fork of [deej](https://github.com/omriharel/deej)
...
deej consists of a [lightweight desktop client](#features) written in Go, and an micro proccessor hardware setup that's simple and cheap to build. [**Check out some versions built by members of our community!**](./community.md)

📦 [Download the latest release](https://github.com/TomDra/deej-extra/releases/latest)
...
deej is written in Go and [distributed](https://github.com/TomDra/deej-extra/releases/latest) as a portable (no installer needed) executable.
...
- The sliders are connected to the analog pins on a microcontroller board (e.g. Arduino Nano/Uno). They're powered from the board's 5V output (see schematic)
- The buttons are connected to the digital pins on a microcontroller board (e.g. Arduino Nano/Uno). They're powered from the board's 5V output (see schematic)
- The board connects via a USB cable to the PC

#### Schematic

![Hardware schematic](assets/deej-extra_schematic.png)
...
- Flash the Arduino chip with the sketch in [`microcontroller-scripts\Arduino`](./microcontroller-scripts\Arduino\deej-5-sliders-6-buttons-vanilla.ino)
...
- Head over to the [releases page](https://github.com/TomDra/deej-extra/releases) and download the [latest version](https://github.com/TomDra/deej-extra/releases/latest)'s executable and configuration file (`deej.exe` and `config.yaml`)
