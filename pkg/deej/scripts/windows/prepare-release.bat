...
MOVE /Y "%DEEJ_ROOT%\deej-extra-release.exe" "%DEEJ_ROOT%\releases\%1\deej-extra.exe" >NUL 2>&1
MOVE /Y "%DEEJ_ROOT%\deej-extra-dev.exe" "%DEEJ_ROOT%\releases\%1\deej-extra-debug.exe" >NUL 2>&1
